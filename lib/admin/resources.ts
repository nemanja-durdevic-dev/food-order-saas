...
const menuItemFields: AdminField[] = [
  ...
  {
    key: "option_group_ids",
    label: "Option Groups",
    helpText: "Customization groups available for this item.",
    join: {
      table: "menu_item_option_groups",
      sourceColumn: "menu_item_id",
      targetColumn: "option_group_id",
      sortColumn: "sort_order",
    },
    relation: { table: "option_groups", labelColumn: "name", restaurantScoped: false },
    searchable: true,
    type: "multiselect",
  },
  {
